        ...
        if (value.menusList.isEmpty || value.menusList[0].menus.isEmpty) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final option = value.menusList[0].menus[index].menu.menuName;
              return SlideTransition(
                  position: widget.animation, child: buildOptionButton(option));
            },
          );
        }
      },
      ...
      builder: (context, value, child) => GestureDetector(
        ...
        child: Container(
          ...
          margin: EdgeInsets.symmetric(
              horizontal: size.height * 0.006, vertical: 8),
